...
MIDDLEWARE = [
    ...
    'authorization.middleware.CookieTokenAuthMiddleware',
...
# OAuth Application credentials (used by auth proxy)
...
ADMIN_INITIAL_PASSWORD = os.environ.get('DJANGO_ADMIN_PASSWORD', '')
